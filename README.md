...
[^1]: Literally "patch" the file. Sometimes config files are generated by the program thus having a lot of default values in them. So I just specify which settings I changed, and patch them in. [see examples](https://github.com/barraIhsan/dotfiles/blob/master/home/dot_config/Vencord/settings/modify_settings.json.tmpl)
