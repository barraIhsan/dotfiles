...
## mpv shaders
# anime4k shaders
download "Anime4K Shaders" "https://github.com/Tama47/Anime4K/releases/latest/download/GLSL_Mac_Linux_High-end.zip" anime4k.zip
...
# mpris support
download "MPRIS support" "https://github.com/eNV25/mpv-mpris2/releases/latest/download/mpris-x86_64-unknown-linux-gnu.so" scripts/mpris.so
